<template>
  <div class="flex">
    <a :href="twitterUrl" target="__blank" rel="nofollow noreferrer">
    ...
    <a :href="facebookUrl" target="__blank" rel="nofollow noreferrer">
      <svg width="29" height="29" fill="currentColor">
    ...
    <a :href="linkedinUrl" target="__blank" rel="nofollow noreferrer">
...
export default {
  ...
  computed: {
    twitterUrl() {
      ...
      url.searchParams.set('text', `${this.title} ${this.url} by @rahmandawibowo`)
      return url.href
    },
    facebookUrl() {
